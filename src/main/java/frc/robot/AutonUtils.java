...
public final class AutonUtils {
    ...
    public static final Map<String, Pose2d> AUTON_TARGET_POSES = Map.ofEntries(
        ...
        Map.entry("BlueNorthDefaultAction", new Pose2d(1.995, 4.727, Rotation2d.fromDegrees(-15.633))),
        // Blue South
        ...
        Map.entry("BlueSouthDefaultAction", new Pose2d(2.272, 3.431, Rotation2d.fromDegrees(30)))
    );
